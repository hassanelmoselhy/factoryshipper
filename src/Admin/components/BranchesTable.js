...
const BranchesTable = ({ branches, onViewDetails, loading = false }) => {
  return (
    <div className="branches-table-wrapper">
      <div className="branches-table-container card-base">
        <div className='table-title'> 
            <h4>قائمة الفروع والمخازن ({branches.length})</h4>
        ...
        <div className="table-header">
          ...
          <div className="header-item employees">عدد الموظفين</div>
